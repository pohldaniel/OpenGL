...
void Shader::loadMatrixArray(const char* location, const std::vector<Matrix4f> matrixArray, const short count, bool transpose) {
	glUniformMatrix4fv(glGetUniformLocation(m_program, location), count, transpose, matrixArray[0][0]);
}
